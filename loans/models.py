...
class Loan(db.Model):
    ...
    def __init__(self, customer_id=0, amount=0, interest=0, payment=0, total_payable=0, outstanding_balance=0, fully_paid_on=None, date_release=None, date_due=None):
