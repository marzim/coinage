...
db.create_all()
#insert
#user = User(1, 0, 0, "guest2","marzim@gmail.com", "jasper")
customer = Customer('marvin','casagnap','marzim@gmail.com','liloan','09089685643')
db.session.add(customer)
customer = Customer('marvin2','casagnap2','marzim@gmail.com','liloan','09089685643')
db.session.add(customer)
customer = Customer('marvin3','casagnap3','marzim@gmail.com','liloan','09089685643')
db.session.add(customer)
#db.session.add(user)
# commit the changes
db.session.commit()
